...
export function iconFilter() { return `<svg viewBox="0 0 24 24" fill="none"><rect x="3" y="5.5" width="18" height="3" rx="1.5" fill="currentColor" opacity="0.25"/><rect x="3" y="5.5" width="10" height="3" rx="1.5" fill="currentColor"/><rect x="3" y="10.5" width="18" height="3" rx="1.5" fill="currentColor" opacity="0.25"/><rect x="3" y="10.5" width="14" height="3" rx="1.5" fill="currentColor"/><rect x="3" y="15.5" width="18" height="3" rx="1.5" fill="currentColor" opacity="0.25"/><rect x="3" y="15.5" width="7" height="3" rx="1.5" fill="currentColor"/></svg>`; }
